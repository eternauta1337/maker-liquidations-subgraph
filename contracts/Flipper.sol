/*
   ...
   0x7d780d82: beg()
   0x4423c5f1: bids(uint256)
   0xc959c42b: deal(uint256)
   0x5ff3a382: dent(uint256,uint256,uint256)
   0x9c52a7f1: deny(address)
   0x29ae8114: file(bytes32,uint256)
   0xc5ce281e: ilk()
   0x351de600: kick(address,address,uint256,uint256,uint256)
   0xcfdd3302: kicks()
   0x65fae35e: rely(address)
   0xcfc4af55: tau()
   0x4b43ed12: tend(uint256,uint256,uint256)
   0xfc7b6aee: tick(uint256)
   0x4e8b1dd5: ttl()
   0x36569e77: vat()
   0xbf353dbb: wards(address)
   0x26e027f1: yank(uint256)
 */
